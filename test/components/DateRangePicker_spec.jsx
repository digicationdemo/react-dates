...
describe('DateRangePicker', () => {
  ...
  describe('day modifier methods', () => {
    ...
    describe('#isLastInRange', () => {
      ...
      afterEach(() => {
        DateRangePicker.prototype.isInSelectedSpan.restore();
      });
    ...
    describe('#isBlocked', () => {
      ...
      afterEach(() => {
        DateRangePicker.prototype.isPastDate.restore();
        DateRangePicker.prototype.doesNotMeetMinimumNights.restore();
      });
